...
public class SecurityConfig {
        ...
        http
                ...
                .exceptionHandling(exceptions -> exceptions
                        .authenticationEntryPoint((request, response, authException) -> {
                            ...
                            response.getWriter().write(errorBody(401, "Unauthorized", "Authentication is required"));
                        })
                        .accessDeniedHandler((request, response, accessDeniedException) -> {
                            response.setStatus(403);
                            response.setContentType(MediaType.APPLICATION_JSON_VALUE);
                            response.getWriter().write(errorBody(403, "Forbidden", "Access is denied"));
                        }))
    ...
    private String errorBody(int status, String error, String message) {
        return """
                ...
                Instant.now().toString(), status, error, message);
    }
}
